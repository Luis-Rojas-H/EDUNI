        ...
        <div class="col-xl-11">
            <div class="row">
              <div class="col-lg-7">
                <div class="card-body p-md-5 mx-md-3">
                  ...
                  <div class="login text-left pt-5">
                    <h1 class="mt-1 mb-3 pb-1">Iniciar sesión</h1>
                  </div>

                  <form action="./backend/auths/login.php"  method="post">
                      <!-- Email input -->
                      <div>
                        <input type="email" id="email" name="email_uni" class="form-control form-control-lg" placeholder="Email" required >
                      </div>
                      <!-- Password input -->
                      <div class="pt-3">
                        <input type="password" id="password" name="pass_uni" class="form-control form-control-lg"  value="" placeholder="Contraseña" required>
                      </div>
                      ...
                      <div class="pt-4">
                        ...
                        <p class="login pt-5">O puedes iniciar sesión con:</p>
                        ...
                        <br>
                        <button class="btn btn-lg btn-block btn-light mb-3" style="color: white;background-color: #3b5998;" type="submit">
                          <img src="img/icono fb.png">
                          &nbspIngresa con Facebook
                        </button>
                        <p class="text-body mt-2 pt-1 mb-0">
                          ¿No tienes una cuenta? &nbsp
                          <a href="./register.php" class="link-danger; background: #27B3D2 color-enlace-login" >Regístrate</a>
                        </p>
                      </div>
                  </form>
                </div>  
              ...
              <div class="col-md-7 col-lg-6 col-xl-4">
                <img src="img/Login imagen.png" class="img-fluid posicion" alt="Login imagen">
              </div>
            </div>   
        </div>
      </div>
